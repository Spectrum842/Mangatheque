        ...
        <?php
            ...
            foreach($allCollection as $collection){
                ...
                <div id="divCollection<?= $collection['ID'] ?>" class="divCollection">
                    ...
                    <button id='updateCollection<?= $collection['id_manga'] ?>' class='updateCollection button modifyButton' data-post-id='<?= $collection['ID'] ?>' data-post-name='<?= htmlspecialchars($collection['name'])?>'>Modifier</button>
