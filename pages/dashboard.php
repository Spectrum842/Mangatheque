...
<div id="divFormCollection" class="modal hide">
    ...
    <form action="" method="post" class="formCollection">
        ...
        <p>
            ...
            <input type="text" id="nameAddCollection" name="name" value="<?= $_POST['name'] ?>" REQUIRED/>
        </p>

        <p>
            <label for="image">Bannière de la collection</label>
            <input type="text" name="image" id="image" value="<?= $_POST['image'] ?>" placeholder="URL de l'image"/>
        </p>

        <p>
            <label for="description">Détails de votre collection</label>
            <textarea name="description" rows="5"><?= $_POST['description'] ?></textarea>
        </p>
...
<div id="divFormUpdate" class="modal hide" >
    ...
    <form action="" method="post" class="formCollection">
        ...
        <p>
            ...
            <input type="text" name="updateName" id="updateName" value="<?= $_POST['updateName'] ?>" REQUIRED />
        </p>

        <p>
            <label for="updateImage">Bannière de la collection</label>
            <input type="text" name="updateImage" id="updateImage" value="<?= $_POST['updateImage'] ?>" placeholder="URL de l'image" />

        </p>

        <p>
            <label for="updateDescription">Description</label>
            <textarea name="updateDescription" id="updateDescription" rows="5"><?= $_POST["updateDescription"]?> </textarea>
        </p>
